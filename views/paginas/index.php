...
<section class="resumen">
    <div class="resumen__grid">
        ...
        <div <?php aos_animacion(); ?> class="resumen__bloque">
            ...
            <p class="resumen__texto">Soportes</p>
        </div>

        

        <div <?php aos_animacion(); ?> class="resumen__bloque">
            <p class="resumen__texto resumen__texto--numero">100</p>
            <p class="resumen__texto">Clientes</p>
        </div>
    </div>
</section>

<section class="speakers">
    <h2 class="speakers__heading">Tecnico</h2>
    <p class="speakers__descripcion">Conoce a nuestro Tecnico</p>
...
<section class="boletos">
    <h2 class="boletos__heading">ticket de Pago</h2>
    <p class="boletos__descripcion">Precios para DevWebSoporte</p>
                                
    <div class="boletos__grid">
        <div <?php aos_animacion(); ?> class="boleto boleto--presencial">
            <h4 class="boleto__logo">&#60;DevWebSoporte/></h4>
