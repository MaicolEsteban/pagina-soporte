<main class="pagina">
    ...
    <p class="pagina__descripcion">Tu suscripcion - Te recomendamos almacenarlo, puedes compartirlo en redes sociales.</p>
    ...
    <div class="boleto-virtual">
        ...
        <div class="boleto boleto--<?php echo strtolower($registro->paquete->nombre); ?> boleto--acceso">
            <div class="boleto__contenido">
                ...
                <p class="boleto__nombre"><?php echo " regalo codigo # " . $registro->regalo_id ?></p>
                <p class="boleto__nombre"><?php echo " usuario # " . $registro->usuario_id ?></p>
