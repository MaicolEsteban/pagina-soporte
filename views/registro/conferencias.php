...
<div class="eventos-registro">
    <main class="eventos-registro__listado">
        <h3 class="eventos-registro__heading--conferencias">&lt;Soportes /></h3>
        <p class="eventos-registro__fecha">Lunes</p>
        ...
        <p class="eventos-registro__fecha">Martes</p>
        <div class="eventos-registro__grid">
        ...
        <p class="eventos-registro__fecha">Miercoles</p>
        <div class="eventos-registro__grid">
        ...
        <p class="eventos-registro__fecha">Jueves</p>
        <div class="eventos-registro__grid">
        ...
        <p class="eventos-registro__fecha">Sábado 6 </p>
        <div class="eventos-registro__grid">
