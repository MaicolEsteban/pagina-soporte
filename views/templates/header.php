<header class="header">
    <div class="header__contenedor">
        ...
        <div class="header__contenido">
            ...
            <p class="header__texto">Colombia</p>
...
<div class="barra">
    <div class="barra__contenido">
        ...
        <nav class="navegacion">
            ...
            <a href="/paquetes" class="navegacion__enlace <?php echo pagina_actual('/paquetes') ? 'navegacion__enlace--actual' : ''; ?>">Paquete</a>
            <a href="/workshops-conferencias" class="navegacion__enlace <?php echo pagina_actual('/workshops-conferencias') ? 'navegacion__enlace--actual' : ''; ?>">Soportes</a>
